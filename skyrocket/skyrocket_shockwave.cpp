...
GLfloat tex2[WAVESTEPS*2*3];
GLfloat vtx2[WAVESTEPS*2*3];
...
// 			glVertex3f (shockwavegeom[i + 1][j][0], -shockwavegeom[i + 1][j][1], shockwavegeom[i + 1][j][2]);
			...
			vtx2[3*j] = shockwavegeom[i + 1][j][0];
			vtx2[3*j+1] = -shockwavegeom[i + 1][j][1];
			vtx2[3*j+2] = shockwavegeom[i + 1][j][2];			
...
// 			glVertex3f (shockwavegeom[i][j][0], -shockwavegeom[i][j][1], shockwavegeom[i][j][2]);
			...
			vtx2[3*j+3] = shockwavegeom[i][j][0];
			vtx2[3*j+4] = -shockwavegeom[i][j][1];
			vtx2[3*j+5] = shockwavegeom[i][j][2];
...
// 		glEnableClientState(GL_TRIANGLE_STRIP);
...
// 			glVertex3f (shockwavegeom[i + 1][j][0], -shockwavegeom[i + 1][j][1], shockwavegeom[i + 1][j][2]);
			...
			vtx2[3*j+3] = shockwavegeom[i + 1][j][0];
			vtx2[3*j+4] = -shockwavegeom[i + 1][j][1];
			vtx2[3*j+5] = shockwavegeom[i + 1][j][2];			
...
// 			glVertex3f (shockwavegeom[i][j][0], -shockwavegeom[i][j][1], shockwavegeom[i][j][2]);
			...
			vtx2[3*j] = shockwavegeom[i][j][0];
			vtx2[3*j+1] = -shockwavegeom[i][j][1];
			vtx2[3*j+2] = shockwavegeom[i][j][2];
		}
...
// 		glDisableClientState(GL_TRIANGLE_STRIP);
