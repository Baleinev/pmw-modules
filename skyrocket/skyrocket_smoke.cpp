...
void initSmoke ()
{
	...
	for (k = 0; k < 5; k++) {
		...
		glTexImage2D(GL_TEXTURE_2D, 4, GL_LUMINANCE_ALPHA, SMOKETEXSIZE,SMOKETEXSIZE , 0, GL_RGB, GL_UNSIGNED_BYTE, smoke); // load the image data into the object
//  glTexParameteri(GL_TEXTURE_2D, GL_GENERATE_MIPMAP, GL_TRUE);		
// 		printf("%d ",SMOKETEXSIZE);
